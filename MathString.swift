...
class MathString: NSObject {
    ...
    func evaluateFrac(_ x: String)->String{
        return x
    }
        ...
        if countB==StackB.count{
            ...
            while  digitLimit < 128 || countB<StackB.count{
                ...
                if countB >= StackB.count{
                    ...
                    if countB==StackB.count{
                        countDot+=Result.count
                        
                        if Array(Result).last! == "0"{
                            countDot-=1
                        }
    ...
    func dividestr2(_ numberA: String,_ numberB: String,_ LimitDigits: Int)->String{
